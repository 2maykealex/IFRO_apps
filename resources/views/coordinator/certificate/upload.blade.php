...
@section('content')
    ...
    <div class="box" id="formulario">
        ...
        <div class="box-body">
            ...
            @isset($certificate)
                <form action="{{ route('coordinator.certificate.update') }}" method="post" enctype="multipart/form-data">
            @else
            ...
            @endif
                ...
                <input id="idStudent" name="idStudent" type="hidden" <?php if (isset($id)) {echo "value='$students->id'";} ?>> 
